...
class MiniFeature
  attr_accessor :start, :end, :strand, :exons, :utrs, :block_gaps, :segment_height, :id, :description
  ...
  #* :description = a description of the feature, to provide more information than that given in :id
  #
  #== Example usage
  #
